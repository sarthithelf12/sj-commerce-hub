...
export const TaxInvoiceForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="invoiceNo" className="text-xs">Invoice No.</Label>
                <Input
                  id="invoiceNo"
                  value={invoiceNo}
            ...
            <div className="space-y-1.5">
              <Label htmlFor="customerAddress" className="text-xs">Billing Address</Label>
              <Textarea
                id="customerAddress"
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-semibold">Ship To (if different from billing)</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="shippingPincode" className="text-xs">PIN</Label>
                <Input
                  id="shippingPincode"
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="text-xs text-muted-foreground space-y-1 pt-2">
              <p>• GST: As applicable per item rate</p>
