...
export const ProformaInvoicePreview = (props: ProformaInvoicePreviewProps) => {
  return (
    <div className="font-sans text-xs leading-relaxed" style={{ color: "#000" }}>
      <div className="text-center border-b-2 border-black pb-3 mb-4">
        ...
        <h2 className="text-base font-bold mt-3 underline">PROFORMA INVOICE</h2>
        <p className="text-xs italic mt-1">This is NOT a Tax Invoice</p>
      </div>

      <div className="flex justify-between mb-4">
        <div>
          <p><strong>Proforma No:</strong> {props.proformaNo}</p>
          <p><strong>Date:</strong> {props.date}</p>
          {props.quotationRef && <p><strong>Quotation Ref:</strong> {props.quotationRef}</p>}
        </div>
      ...
      <div className="mb-4 border-t border-black pt-2">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>Final Tax Invoice will be issued upon delivery</li>
        </ul>
      </div>
